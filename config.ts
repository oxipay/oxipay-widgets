export class Config {
    ...
    public static moreInfoUrl = 'https://widgets.oxipay.co.nz/content/html/ExternalModal.html';
    public static registerInterestUrl = 'https://widgets.oxipay.co.nz/content/html/Signup.html';
    public static baseContentUrl = 'https://images.oxipay.com.au';
    public static priceInfoUrl = 'https://widgets.oxipay.co.nz/content/html/PriceInfo.html';
}
